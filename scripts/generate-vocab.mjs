    ...
    levels: [
      {
        id: 'n5',
        label: 'JLPT N5',
        description: 'Beginner — everyday basics (~700 words)',
      ...
      },
      {
        id: 'n4',
        label: 'JLPT N4',
        description: 'Elementary — basic grammar & vocabulary (~650 words)',
        sourceFile: 'ja/n4.json',
        outputFile: 'ja/n4.json',
      },
      {
        id: 'n3',
        label: 'JLPT N3',
        description: 'Intermediate — everyday situations (~1800 words)',
        sourceFile: 'ja/n3.json',
        outputFile: 'ja/n3.json',
      },
      {
        id: 'n2',
        label: 'JLPT N2',
        description: 'Upper-intermediate — broad topics (~1800 words)',
        sourceFile: 'ja/n2.json',
        outputFile: 'ja/n2.json',
      },
      {
        id: 'n1',
        label: 'JLPT N1',
        description: 'Advanced — near-native fluency (~2600 words)',
        sourceFile: 'ja/n1.json',
        outputFile: 'ja/n1.json',
      },
    ],
  },
